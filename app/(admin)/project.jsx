...
import { fetchProjectDetails, fetchProjectList } from "../../services/api";
              ...
              {isExpanded && details && !isLoading && (
                <View className="px-5 pb-5 border-t border-gray-100">
                  ...
                  <View className="flex-row space-x-3 gap-2 mb-5">
                    ...
                    <View style={{ backgroundColor: "#940101" }} className="flex-1 p-3 rounded-lg border border-blue-100">
                  ...
                  <View className="flex-row justify-between items-center">
                    ...
                    <View className={`px-3 py-1 rounded-full ${
                      details.Project_Status === 2 ? "bg-green-50 border-[1px] border-green-100" : "bg-amber-50 border-[1px] border-amber-100"
                    }`}>
